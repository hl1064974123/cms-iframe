<<<<<<< HEAD
		window.onload=function(){
			...
			$("#iframe-ul-menu").append("<li  helei-id='"+src+"' class='li-active li-all' onclick='liShowIframe(this)'><span  >"+text+"</span></li>");
				...
				if(fActive[i].getAttribute("helei-id")==src){
					...
					if (fActive[i] != null){
						if(i>0){
							...
							window.location.herf = window.location.href = window.location.origin+"/admin"
						}
					}
				}
			}
>>>>>>> 606e9a7... Change-Id: Ic33662fd8e2988dbc25d5436a27f399cd1635d19
		}